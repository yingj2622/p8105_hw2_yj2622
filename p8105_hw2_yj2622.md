...
the trashwheel collectes that trash, and stores it in a dumpster.
  ...
  - The total precipitation in 2018 was 70.33 inches. The median number
    of sports balls in 2017 was 8.
...
subway in NYC.
  ...
  - It contains information about station name, location, routes and
  ...
  - And these data are not tidy because how routes were arranged are not
    proper.
...
So there are 17 stations which both serve A train and are ADA compliant.
...
Read the first ten lines of snp\_data:
...
```
  ...
  - In the pols\_month dataset, there are 822 rows and 9 columns, and
    the range of year is 1947 to 2015. It provides information about
    year, month, number of governors, senators and representatives who
    are democratic or republican respectively, and the president’s party
    at that time.

  - In the snp dataset, there are 787 rows and 3 columns. The year
    ranges from 1950 to2015. It provides information about time and the
    closing values of the S\&P stock index.
