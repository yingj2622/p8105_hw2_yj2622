 ...
 * The total precipitation in 2018 was `r sum(pull(precip_df,total)[pull(precip_df,year) == 2018])`. The median    number of sports balls in 2017 was `r  median(pull(mr_trash_wheel_data,sports_balls))`.
...
```
 ...
 Last, I calculat ethe proportion of entrances/ exits without vending allow entrance:
